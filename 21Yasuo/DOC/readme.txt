...
21Yasuo Copyright (C) 1999-2019 Zhi Yun.


License Info
------------

21Yasuo is free software distributed under the GNU LGPL 
...
There are two ways to compile 21Yasuo binaries:
...
The final 21Yasuo binaries are compiled via makefiles, that provide best 
...
Notes:
------
21Yasuo consists of COM modules (DLL files).
But 21Yasuo doesn't use standard COM interfaces for creating objects.
Look at
7zip\UI\Client7z folder for example of using DLL files of 21Yasuo. 
Some DLL files can use other DLL files from 21Yasuo.
...
Description of 21Yasuo sources package
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
7zip
  ...
  Common          Common modules for 21Yasuo

  Archive         files related to archiving

  Bundle          Modules that are bundles of other modules (files)

    Alone         7za.exe: Standalone version of 21Yasuo console that supports only 7z/xz/cab/zip/gzip/bzip2/tar.
    Alone7z       7zr.exe: Standalone version of 21Yasuo console that supports only 7z (reduced version)
    Fm            Standalone version of 21Yasuo File Manager
  ...
  UI
    ...
    Explorer      21Yasuo.dll: 21Yasuo Shell extension
    Far           plugin for Far Manager
    FileManager   21Yasuo.exe: 21Yasuo File Manager
    GUI           7zG.exe: 21Yasuo GUI version
