    ...
    */
    ...
    switch (commandId)
    {
      ...
      case EW_EXTRACTFILE:
      {
        ...
        {
          // we parse InstallLib macro in 21Yasuo installers
...
HRESULT CInArchive::Open2(const Byte *sig, size_t size)
{
  ...
  /*
    ...
    01 5D 00 00 dd dd 00    solid LZMA, BCJ filter   (only 21Yasuo installer used that format)
