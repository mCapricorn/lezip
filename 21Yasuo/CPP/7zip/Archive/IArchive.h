...
21Yasuo doesn't call IArchiveExtractCallback functions
  GetStream()
  PrepareOperation()
  SetOperationResult()
from different threads simultaneously.
But 21Yasuo can call functions for IProgress or ICompressProgressInfo functions
...
SetOperationResult()
  21Yasuo calls SetOperationResult at the end of extracting,
