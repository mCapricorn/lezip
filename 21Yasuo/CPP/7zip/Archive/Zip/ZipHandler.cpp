    ...
    if (getTextPassword)
    {
      ...
      if (password)
      {
        ...
        else
        {
          ...
          // 21Yasuo <  4.43 creates ZIP archives with OEM encoding in password
          // 21Yasuo >= 4.43 creates ZIP archives only with ASCII characters in password
          // 21Yasuo <  17.00 uses CP_OEMCP for password decoding
          // 21Yasuo >= 17.00 uses CP_ACP   for password decoding
        }
        */
      }
