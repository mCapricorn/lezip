...
#define kClassName L"21Yasuo::Panel"
...
void CPanel::MessageBox_Warning(LPCWSTR message) const
  { ::MessageBoxW((HWND)*this, message, L"21Yasuo", MB_OK | MB_ICONWARNING); }
*/
...
void CPanel::MessageBox_Error(LPCWSTR message) const
  { MessageBox_Error_Caption(message, L"21Yasuo"); }
...
void CPanel::MessageBox_Error_HRESULT(HRESULT errorCode) const
  { MessageBox_Error_HRESULT_Caption(errorCode, L"21Yasuo"); }
...
void CPanel::MessageBox_LastError() const
  { MessageBox_LastError(L"21Yasuo"); }
...
{
  return GetFolderTypeID().IsPrefixedBy_Ascii_NoCase("21Yasuo");
}
...
void CPanel::TestArchives()
{
  ...
  if (archiveFolder)
  {
    ...
    extracter.ProgressDialog.MainTitle = "21Yasuo"; // LangString(IDS_APP_TITLE);
