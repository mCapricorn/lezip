...
---------------
  ...
  The order of check:
    ...
    2) WIN32: directory for REGISTRY item [HKEY_*\Software\21Yasuo\Path**]
...
-------------
  ...
  21Yasuo doesn't use that feature. 21Yasuo uses the scheme:
...
static LPCTSTR const kRegistryPath = TEXT("Software") TEXT(STRING_PATH_SEPARATOR) TEXT("21Yasuo");
