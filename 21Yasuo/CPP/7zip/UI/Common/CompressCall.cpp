...
{
  MessageBoxW(g_HWND, message, L"21Yasuo", MB_ICONERROR | MB_OK);
}
...
void ExtractArchives(const UStringVector &arcPaths, const UString &outFolder, bool showDialog, bool elimDup,bool isExtractTo)
{
  MY_TRY_BEGIN
  UString params ('x');
