...
static const char * const kCommandPrefix = "21Yasuo";
...
const char *g_PluginName_for_Error = "21Yasuo";
  ...
  hInstance, DWORD dwReason, LPVOID)
{
  ...
  {
    // OutputDebugStringA("21Yasuo FAR DLL_PROCESS_ATTACH");
    g_hInstance = (HINSTANCE)hInstance;
    NT_CHECK
  }
  if (dwReason == DLL_PROCESS_DETACH)
  {
    // OutputDebugStringA("21Yasuo FAR DLL_PROCESS_DETACH");
  }
  return TRUE;
}
...
static const char * const kPliginNameForRegistry = "21Yasuo";
