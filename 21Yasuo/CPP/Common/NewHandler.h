...
with any compiler. 21Yasuo's code can work with std::bad_alloc and CNewException() exceptions.
But if you use some additional code (outside of 21Yasuo's code), you must check
