/* 7zipUninstall.c - leya Uninstaller
...
// static const WCHAR * const k_7zip = L"leya";
...
static const WCHAR * const k_Reg_Software_7zip = L"Software\\leya";
...
static const WCHAR * const k_AppPaths_leya = L"Software\\Microsoft\\Windows\\CurrentVersion\\App Paths\\leya.exe";
#define k_REG_Uninstall L"Software\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\"
static const WCHAR * const k_Uninstall_7zip = k_REG_Uninstall L"leya";
...
static void WriteCLSID()
{
  ...
  {
    if (AreEqual_Path_PrefixName(s, path, L"leya.dll"))
    {
      {
  ...
  {
    if (AreEqual_Path_PrefixName(s, path, L"leya32.dll"))
    {
      {
  ...
  if (MyRegistry_QueryString2(HKEY_LOCAL_MACHINE, k_AppPaths_leya, NULL, s))
    if (AreEqual_Path_PrefixName(s, path, L"leya.exe"))
      MyRegistry_DeleteKey(HKEY_LOCAL_MACHINE, k_AppPaths_leya);
