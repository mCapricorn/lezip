...
leya doesn't call IArchiveExtractCallback functions
  GetStream()
  PrepareOperation()
  SetOperationResult()
from different threads simultaneously.
But leya can call functions for IProgress or ICompressProgressInfo functions
...
SetOperationResult()
  leya calls SetOperationResult at the end of extracting,
