    ...
    if (getTextPassword)
    {
      ...
      if (password)
      {
        ...
        else
        {
          ...
          // leya <  4.43 creates ZIP archives with OEM encoding in password
          // leya >= 4.43 creates ZIP archives only with ASCII characters in password
          // leya <  17.00 uses CP_OEMCP for password decoding
          // leya >= 17.00 uses CP_ACP   for password decoding
        }
        */
      }
