...
static LPCTSTR const k_ShellExtName = TEXT("leya Shell Extension");
...
static LPCSTR const k_KeyPostfix_ContextMenu = "\\shellex\\ContextMenuHandlers\\leya";
static LPCSTR const k_KeyPostfix_DragDrop    = "\\shellex\\DragDropHandlers\\leya";
