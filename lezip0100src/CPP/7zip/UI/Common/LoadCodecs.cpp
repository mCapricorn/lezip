...
---------------
  ...
  The order of check:
    ...
    2) WIN32: directory for REGISTRY item [HKEY_*\Software\leya\Path**]
...
-------------
  ...
  leya doesn't use that feature. leya uses the scheme:
...
static LPCTSTR const kRegistryPath = TEXT("Software") TEXT(STRING_PATH_SEPARATOR) TEXT("leya");
