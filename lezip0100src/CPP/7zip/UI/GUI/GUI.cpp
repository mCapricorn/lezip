...
{
  MessageBoxW(NULL, message, L"leya", MB_ICONERROR | MB_OK);
}
...
static const char * const kNoFormats = "leya cannot find the code that works with archives.";
...
static int Main2()
{
  ...
  if (commandStrings.Size() == 0)
  {
    MessageBoxW(0, L"Specify command", L"leya", 0);
    return 0;
  }
        ...
        || options.Command.IsFromUpdateGroup()))
  {
    ...
    {
      UString s ("leya cannot load module: ");
