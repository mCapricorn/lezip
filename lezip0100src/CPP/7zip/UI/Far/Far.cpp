...
static const char * const kCommandPrefix = "leya";
...
const char *g_PluginName_for_Error = "leya";
  ...
  hInstance, DWORD dwReason, LPVOID)
{
  ...
  {
    // OutputDebugStringA("leya FAR DLL_PROCESS_ATTACH");
    g_hInstance = (HINSTANCE)hInstance;
    NT_CHECK
  }
  if (dwReason == DLL_PROCESS_DETACH)
  {
    // OutputDebugStringA("leya FAR DLL_PROCESS_DETACH");
  }
  return TRUE;
}
...
static const char * const kPliginNameForRegistry = "leya";
