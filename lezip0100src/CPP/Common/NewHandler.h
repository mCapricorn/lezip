...
with any compiler. leya's code can work with std::bad_alloc and CNewException() exceptions.
But if you use some additional code (outside of leya's code), you must check
