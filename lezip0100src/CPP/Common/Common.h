...
/*
This file is included to all cpp files in leya.
Each folder contains StdAfx.h file that includes "Common.h".
So leya includes "Common.h" in both modes:
  with precompiled StdAfx.h
and
  without precompiled StdAfx.h

If you use leya code, you must include "Common.h" before other h files of leya.
If you don't need some things that are used in leya,
